      ...
      <div className="bg-blue-50 p-6 rounded-lg shadow-sm">
        ...
        <div className="space-y-3">
          <p className="text-gray-800">
            <strong className="font-medium text-blue-700">Nombre:</strong>{" "}
            {auth.name}
          </p>
          <p className="text-gray-800">
            <strong className="font-medium text-blue-700">Apellido:</strong>{" "}
            {auth.lastname}
          </p>
          <p className="text-gray-800">
            <strong className="font-medium text-blue-700">Email:</strong>{" "}
            {auth.email}
          </p>
          <p className="text-gray-800">
          ...
          <p className="text-gray-800">
            <strong className="font-medium text-blue-700">Género:</strong>{" "}
            {auth.sexo}
          </p>
          <p className="text-gray-800">
            <strong className="font-medium text-blue-700">Telefono:</strong>{" "}
            {auth.telefono}
          </p>
          <p className="text-gray-800">
          ...
          <p className="text-gray-800">
            <strong className="font-medium text-blue-700">Edad:</strong>{" "}
            {auth.edad} años
          </p>
        </div>
      </div>
