...
const LoginPage = () => {
  ...
  const SocialLinks = () => (
    <div className="space-y-4">
      <a
        href="#"
        className="flex items-center space-x-3 text-green-600 hover:text-green-700 transition duration-150 ease-in-out"
      >
      ...
      <a
        href="#"
        className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition duration-150 ease-in-out"
      >
        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          <path
            fillRule="evenodd"
        ...
        <span className="text-sm font-medium">
          Comunidad de salud en Facebook
        </span>
      </a>
      <a
        href="#"
        className="flex items-center space-x-3 text-pink-600 hover:text-pink-700 transition duration-150 ease-in-out"
      >
        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          <path
            fillRule="evenodd"
        ...
        <span className="text-sm font-medium">
          Consejos de salud en Instagram
        </span>
      </a>
      <a
        href="#"
        className="flex items-center space-x-3 text-black hover:text-gray-700 transition duration-150 ease-in-out"
      >
        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          <path
            fillRule="evenodd"
      ...
      <div className="flex flex-col md:flex-row items-center justify-center w-full p-4">
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-8 m-4 border-4 border-blue-200">
          <div className="flex items-center justify-center mb-8">
            <img
              src="https://img.freepik.com/vector-gratis/logotipo-clinica-salud-simple-moderno_23-2148916851.jpg?w=80&h=80&fit=crop"
              alt="Logo SaludTotal"
        ...
        <div className="hidden md:block w-full max-w-md p-8 m-4">
          ...
          <div className="bg-gradient-to-r from-green-100 to-blue-100 rounded-lg shadow-lg p-6 border-2 border-green-300">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">
              +50k Pacientes Satisfechos
            </h3>
            <div className="flex mb-4">
              <img
                src="https://img.freepik.com/foto-gratis/retrato-hombre-blanco-aislado_53876-40306.jpg?w=30&h=30&fit=crop"
                alt="Usuario"
                className="w-8 h-8 rounded-full border-2 border-white"
              />
              <img
                src="https://img.freepik.com/foto-gratis/mujer-joven-hermosa-sueter-rosa-aspecto-natural-sonriente-retrato-aislado-cabello-largo_285396-896.jpg?w=30&h=30&fit=crop"
                alt="Usuario"
                className="w-8 h-8 rounded-full border-2 border-white -ml-2"
              />
              <img
                src="https://img.freepik.com/foto-gratis/hombre-guapo-sonriente-confiado-manos-cruzadas-pecho_176420-18743.jpg?w=30&h=30&fit=crop"
                alt="Usuario"
                className="w-8 h-8 rounded-full border-2 border-white -ml-2"
              />
              <img
                src="https://img.freepik.com/foto-gratis/bastante-sonriendo-alegremente-femenina-cabello-rubio-vestida-casualmente-mirando-satisfaccion_176420-15187.jpg?w=30&h=30&fit=crop"
                alt="Usuario"
                className="w-8 h-8 rounded-full border-2 border-white -ml-2"
              />
            ...
            <p className="text-sm text-gray-600">
              Únase a nuestra comunidad de pacientes satisfechos y experimente
